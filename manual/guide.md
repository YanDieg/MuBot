...
This messages is linked with the commands /start, /menu and when no commands is recognized (*UNKNOWN_MESSAGE*). It will be shown by the bot to the user, when a user performs one of this action
```python
